# Runtime verify для `:my-profile` после recovery
...
`sys.boot_completed=1`. Runtime-команда завершилась успешно; для
`:my-profile` выполнено 5 instrumentation tests без пропусков и падений.
