# Текущая спецификация реализации Android: my-profile

## Происхождение baseline

- **Feature:** `my-profile`
- **Платформа:** `Android`
- **Продуктовый baseline:** `specs/product/my-profile/SPECIFICATION.md` — текущий продуктовый контракт после `archive product completed`; до его публикации общий контракт зафиксирован в provenance текущего archive.
- **Источник:** `Android/specs/my-profile/archive/2026-07-17-my-profile/implementation-spec.md`
- **SHA-256 источника:** `4eaa386b05ace64d075171ba2a691957d901ce97bc296e1c50fbf46559a0310a`
- **Архив:** `Android/specs/my-profile/archive/2026-07-17-my-profile`
- **Evidence:** `Android/specs/my-profile/archive/2026-07-17-my-profile/archive-receipt.json`
