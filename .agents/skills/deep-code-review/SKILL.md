...
fix, вернуть exact lifecycle route из phase. Android finding после отдельного
Implement маршрутизировать в `verify android ...`; сам review не называть
fixed/verified до отдельного успешного Verify.
