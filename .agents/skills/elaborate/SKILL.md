...
Существующий product `SPECIFICATION.md` читать как immutable current baseline;
candidate `spec.md` формировать как полный post-change контракт, baseline не
включать в review fingerprint.
